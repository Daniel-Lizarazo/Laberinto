...
(define (nivel1);; primer nivel
  ...
  (movimiento 249 32 win1 0(key-value (get-key-press win1)) 0 0 0 0 0);;llamado a la función movimiento {movimiento x y ventana (lector de teclado)}
  )
